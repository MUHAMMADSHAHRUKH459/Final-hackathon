      ...
      <div className="h-[180px] bg-black  container mx-auto rounded-[30px] absolute -top-16 left-2/4 -translate-x-2/4 flex items-center justify-between px-2 md:px-8 lg:px-16">
        ...
        <div className="flex flex-col gap-2">
          <input
            ...
            className="bg-transparent border border-white rounded-[30px] px-4 py-2"
          />
          <button className="bg-white text-black px-4 py-2 rounded-[30px]">
            Subscribe
          </button>
        </div>
      </div>
        ...
        <div className="mt-16 py-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              ...
              <img src="/images/master.png" alt="Mastercard" className="h-8" />
              <img src="/images/paypal.png" alt="PayPal" className="h-8" />
              <img src="/images/apple.png" alt="Apple Pay" className="h-8" />
              <img src="/images/google.png" alt="Google Pay" className="h-8" />
            </div>
          </div>
        </div>
      </div>
